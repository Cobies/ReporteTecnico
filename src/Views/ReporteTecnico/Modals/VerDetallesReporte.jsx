                ...
                <tbody className="text-center">
                  {articulos?.length === 0 ? (
                    ...
                    articulos?.map((x, index) => (
                      <tr key={index}>
                        <td>
                          {moment(x.FechaCreado || x.fechaCreado).format('L')}
                        </td>
                        ...
                        <td>
                          {moment(x.FechaCompra || x.fechaCompra).isValid()
                            ? moment(x.FechaCompra || x.fechaCompra).format('L')
                            : 'Sin Fecha'}
                        </td>
                      </tr>
                    ))
